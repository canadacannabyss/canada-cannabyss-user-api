...
import emailConfirmationTemplate from '../templates/emailRegisterCanadaCannabyssTeamReseller'
import { ITransporterConfig } from '../interfaces/services/emailSender'

export default async (email: string, createdBy: Date) => {
  ...
  jwt.sign(
    ...
    async (err, emailToken) => {
      ...
      const info = await transporter.sendMail({
        ...
        subject:
          'Account Register Invitation | Canada Cannabyss Team - Canada Cannabyss', // Subject line
